...
\begin{theorem}{Disintegration for Product spaces}{thm:disintegration}
...
\begin{lemma}{Dudley/Gluing}{lem:gluing}
...
\begin{definition}{Wasserstein distance}{def:wasserstein}
...
\begin{theorem}{Wasserstein distance is a metric}{thm:wasserstein-metric}
...
\begin{lemma}{Iterated Gluing/Dudley}{lem:iterated-gluing}
